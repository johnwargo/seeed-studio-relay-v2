...
This initializes the first board with a default address of `0x20`.  The board defaults to this address, but you can change the DIP switches on the board to set a different address. 

>  **Note:** I don't know how the DIP switches relate to the digital value, but hopefully I can either get the folks at Seeed Studio to update the Wiki with the details. `ox20` is a decimal 32, but I'm not sure how that relates to the switches. If you figure this out, let me know and I'll update this.
